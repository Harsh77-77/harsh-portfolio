...
<div className="relative top-[-80px] mt-[-96px] bg-gray-800 text-white w-full h-96 ">
    ...
    ></img>
    <h1 className=" text-2xl lg:text-4xl font-bold px-5 lg:px-10 pt-5">Education</h1>
    ...
    <div className="flex px-5 lg:px-10 whitespace-nowrap text-gray-400">
      ...
      <p className=" mt-[-24px]  text-xs ml-20 lg:text-base lg:whitespace-normal md:ml-96 lg:ml-96 lg:pl-64">
    ...
    <div className="flex px-5 whitespace-nowrap lg:px-10 text-gray-400">
      ...
      <p className="ml-40 lg:ml-96 lg:pl-96 md:ml-96 md:px-16">2021-24</p>
    </div>

    <p className="px-5 lg:px-10 text-gray-400">Overall CGPA-8.2</p>

    <br></br>
    <p className="px-5 lg:px-10 text-gray-400 ">Senior Secondary Education</p>
    <div className="flex  text-gray-400">
      <p className="px-5 whitespace-nowrap lg:px-10 text-gray-400 ">
        Central board of secondary education
      </p>
      <p className="px-2  whitespace-nowrap text-gray-400 lg:ml-96 lg:pl-48  md:ml-72">2020-21</p>
    </div>
    <br></br>
    ...
    <div className="flex  text-gray-400">
      ...
      <p className="px-2 text-gray-400  lg:ml-96 lg:pl-48 whitespace-nowrap  md:ml-72">2018-19</p>
    </div>
  </div>
  ...
  <div className="border-t-[1px] border-blue-100 "></div>
          ...
          <div class="flex flex-wrap -mx-4 lg:justify-between">
            <div class="w-full px-4 lg:w-1/2 xl:w-6/12">
              <div class="mb-12 max-w-[570px] lg:mb-0">
                ...
                <h2 class="text-dark text-indigo-600 mb-6 text-[32px] font-bold uppercase sm:text-[40px] lg:text-[36px] xl:text-[40px]">
                  CONNECT WITH ME!
                </h2>
                <p class="text-base leading-relaxed text-body-color dark:text-dark-6 mb-9">
                  Feel free to reach out to discuss potential
                  collaborations, share ideas, or just say hello. I’m always
                ...
                <div class="mb-8 flex w-full max-w-[370px]">
                  ...
                  <div class="w-full">
                    ...
                    <p class="text-base text-body-color dark:text-dark-6">
                      A-158a Lajpat Nagar, Sahibabad, Ghaziabad (NCR)
                    </p>
                  </div>
                </div>
                <div class="mb-8 flex w-full max-w-[370px]">
              ...
              <div class="relative p-8 bg-white rounded-lg shadow-lg dark:bg-dark-2 sm:p-12">
                <form>
                  ...
                  <div>
                    <button
                      type="submit"
                      class="w-full p-3 bg-gradient-to-r from-blue-300 to-blue-900 transition border rounded border-primary bg-primary hover:bg-opacity-90"
                    >
                      Send Message
                    </button>
                  </div>
